...
public class PersonController {
    ...
    public void showContent (){
        Path path = Paths.get("C:\\Users\\juanpablo.avila\\Desktop\\Proyectos Instrucion\\BackEnd Java\\Introduccion\\Java Development Kit (JDK)\\ej.1.1\\Ficheros\\prueba.txt");
